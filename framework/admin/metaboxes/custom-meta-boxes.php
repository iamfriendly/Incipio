...
define( 'CMB_URL', get_bloginfo( 'template_directory' ) . '/framework/admin/metaboxes' );


require_once locate_template( '/framework/admin/metaboxes/classes.fields.php' );
require_once locate_template( '/framework/admin/metaboxes/class.cmb-meta-box.php' );
